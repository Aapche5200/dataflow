...
join
    (
        ...
        from jiayundw_dws.flow_pid_action_di as ua 
            ...
            group by ua.log_date,front_cate_one,front_cate_two
    ) as a on a.front_cate_one=c.front_cate_one and a.front_cate_two=c.front_cate_two
join 
    (
        select
        ...
        from jiayundw_dm.sale_order_info_history_df as so 
            ...
            group by date(so.create_at+interval '8' hour),a.front_cate_one,a.front_cate_two
    ) as b on c.front_cate_one=b.front_cate_one and c.front_cate_two=b.front_cate_two
