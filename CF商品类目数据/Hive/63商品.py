...
where ua.log_date between '2020-04-16' and '2020-04-16' 
...
where sol.is_delivery=0 and date(so.create_at+interval '8' hour) between '2020-04-16' and '2020-04-16' 
group by item_no,
...
writer = pd.ExcelWriter('63商品-16号' + '.xlsx')
