...
having  count(*)>=2
--①产线员工数量
-- delete  from ads_gp_oa_t_hr_eminf_inf_df where date(dateid)=date('2023-04-27')
--select *  from ads_gp_oa_t_hr_eminf_inf_df where date(dateid)=date('2023-04-28')
...
--12-2023 经营结果数据表
--delete  from ads_gp_all_t_cpx_cp_zhibiao_df where date(dateid)=date('2023-04-27');
--select * from ads_gp_all_t_cpx_cp_zhibiao_df where date(dateid)=date('2023-04-28');
