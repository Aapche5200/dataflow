...
from CFcategory.dbo.category_123_day_wholee
...
@app.callback([Output('my-graph-table-ca-ott-wholee', 'children'), Output('download-link-ott-wholee', 'href')],
              [Input('date-picker-range-cate-yewuxian-ott-wholee', 'start_date'),
               Input('date-picker-range-cate-yewuxian-ott-wholee', 'end_date'),
               Input('my-dropdown-table-ca-ott-wholee', 'value'),
               Input('front-cate-one-goods-ott-wholee', 'value'),
               Input('front-cate-two-goods-ott-wholee', 'value'),
               ], )
