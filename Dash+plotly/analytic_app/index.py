...
app.layout=html.Div([html.Link(
    ...
    html.Nav(id='nav', className='navbar navbar-default',
             children=
             html.Div(className='container-fluid',
                      children=[
                          html.Div(className='navbar-header',
                                   children=
                                   html.Div(className="navbar-brand",children='Analytic App')
                                   ),
                          ...
                          html.P(className='text-right vertical-center',
                                 children=html.A(className='text-muted',href="https://plot.ly/products/dash/",
                                                 children='Created using Dash by Plotly'))
                      ])
             )
