...
def update_table_ca(start_date, end_date, selected_dropdown_value_table_ca):
    ...
    vals_table_ca = \
        [list(filter_data_table_ca_total[filter_data_table_ca_total['类型'] == selected_dropdown_value_table_ca]['访客环比']),
         list(filter_data_table_ca_total[filter_data_table_ca_total['类型'] == selected_dropdown_value_table_ca]['销售环比']),
         list(filter_data_table_ca_total[filter_data_table_ca_total['类型'] == selected_dropdown_value_table_ca]['销量环比']),
         list(filter_data_table_ca_total[filter_data_table_ca_total['类型'] == selected_dropdown_value_table_ca]['转化环比']),
         list(
             filter_data_table_ca_total[filter_data_table_ca_total['类型'] == selected_dropdown_value_table_ca]['客单价环比']),
         list(filter_data_table_ca_total[filter_data_table_ca_total['类型'] == selected_dropdown_value_table_ca]['在售环比'])]
