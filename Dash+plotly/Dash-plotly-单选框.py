...
x = data_category[data_category["category_one"] == "全类目"][["log_date", "laiyuan", "category_one", "gmv"]]
...
app.layout = html.Div(children=[
    ...
    html.Div([dcc.RadioItems(
        ...
        options=[
            ...
            {"label": "CVR", "value": "CVR"},
            {"label": "qty", "value": "qty"},
            {"label": "kd_price", "value": "kd_price"},
            {"label": "goods_nums", "value": "goods_nums"},
        ],
        value="GMV")
    ])
],
...
def update_graph(selected_dropdown_value_ca, zhibiao_type_radio):  # 类目销售趋势回调数据
    ...
    zhibiao_type_ca = {"GMV": "GMV", "UV": "UV", "CVR": "CVR", "qty": "qty",
                       "kd_price": "kd_price", "goods_nums": "goods_nums"}
    ...
    for leimu in selected_dropdown_value_ca:
        # 设置total图例及数据
        trace1_ca_gmv.append(go.Scatter(x=data_category_total[data_category_total["category_one"] == leimu]["log_date"],
        ...
        # 设置cf图例及数据
        trace2_ca_gmv.append(go.Scatter(x=data_category_cf[data_category_cf["category_one"] == leimu]["log_date"],
        ...
        trace1_ca_uv.append(go.Scatter(x=data_category_total[data_category_total["category_one"] == leimu]["log_date"],
                                       y=data_category_total[data_category_total["category_one"] == leimu]["uv"],
                                       mode='lines', opacity=0.7, name=f'Total {dropdown_ca[leimu]}',
                                       line=dict(width=3),
                                       textposition='bottom center'))
        # 设置cf图例及数据
        trace2_ca_uv.append(go.Scatter(x=data_category_cf[data_category_cf["category_one"] == leimu]["log_date"],
        ...
        trace1_ca_cvr.append(go.Scatter(x=data_category_total[data_category_total["category_one"] == leimu]["log_date"],
                                        y=data_category_total[data_category_total["category_one"] == leimu]["cvr"],
                                        mode='lines', opacity=0.7, name=f'Total {dropdown_ca[leimu]}',
                                        line=dict(width=3),
                                        textposition='bottom center'))
        # 设置cf图例及数据
        trace2_ca_cvr.append(go.Scatter(x=data_category_cf[data_category_cf["category_one"] == leimu]["log_date"],
        ...
        trace1_ca_qty.append(go.Scatter(x=data_category_total[data_category_total["category_one"] == leimu]["log_date"],
                                        y=data_category_total[data_category_total["category_one"] == leimu]["qty"],
                                        mode='lines', opacity=0.7, name=f'Total {dropdown_ca[leimu]}',
                                        line=dict(width=3),
                                        textposition='bottom center'))
        # 设置cf图例及数据
        trace2_ca_qty.append(go.Scatter(x=data_category_cf[data_category_cf["category_one"] == leimu]["log_date"],
        ...
        trace1_ca_kd_price.append(
            go.Scatter(x=data_category_total[data_category_total["category_one"] == leimu]["log_date"],
                       ...
                       textposition='bottom center'))
        # 设置cf图例及数据
        trace2_ca_kd_price.append(go.Scatter(x=data_category_cf[data_category_cf["category_one"] == leimu]["log_date"],
    ...
    chart_data = {"GMV": traces_ca_gmv, "UV": traces_ca_uv, "CVR": traces_ca_cvr,
                  "qty": traces_ca_qty, "kd_price": traces_ca_kd_price, "goods_nums": traces_ca_goods_nums,
                  }

    data_ca = [val_ca for sublist in chart_data[zhibiao_type_radio] for val_ca in sublist]
