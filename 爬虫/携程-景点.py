...
def gethtml(place):
    try:
        driver.get('https://piao.ctrip.com/dest/u-%E4%B8%8A%E6%B5%B7/s-tickets/')
        welcome = WebDriverWait(driver, 10).until(
            EC.presence_of_element_located((By.CSS_SELECTOR, "body > div.jewel_pop_box > div.jewel_pop > span")))
        welcome.click()
        seaech = driver.find_element_by_css_selector(
            '#searchpanel > div.search_wrap > div.new_search_content > div > input')
...
# 创建文件夹
def make(place):
    path = '/Users/apache/Downloads/A-python/'
